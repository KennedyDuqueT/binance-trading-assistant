...
# Backtest local — baseline utBotOnly (sólo señales UT Bot)
...
# Backtest local — confluenceEngine (3-de-4 + stop híbrido + TP único @ 2.5R + sizing por tier)
npm run backtest -- BTCUSDT 1h --strategy confluenceEngine --to 2026-04-30T00:00:00Z
